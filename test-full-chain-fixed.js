...
// Create a LULCODE test program with CORRECT syntax
...
BTW String operations with implicit calls
VAR message ITZ "Hello, World"
VAR pos ITZ indexOf message "World"
VISIBLE "Position found"
VISIBLE pos
...
VISIBLE "Alice score:: 100"
VISIBLE "Bob score:: 85"
...
console.log('3. Transpiled LOLCODE (first 30 lines):');
console.log('─'.repeat(40));
